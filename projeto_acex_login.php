...
<div class="container">
   ...
   <a href="projeto_acex_login.php"> <div id="nav1"><center><h4>Login</h4></center></div></a>
    <a href="projeto_acex_curso.php"><div id="nav2"><h4>Trilha de apredizagem</h4></div></a>
   <a href="projeto_acex_login.php"> <div id="nav3"><h4>Sair</h4></div></a>
    ...
    <br><br><h1>Bem Vind@</h1> <br><br><br>
        ...
        <div class="usuario">
          <label for="inputEmail3" class="col-sm-2 col-form-label"><h4></h4> </label>
          <div class="usuario1">
              <input type="email" name="email"class="usuario01" id="inputEmail3"  placeholder="Usuario" >
          </div>
        </div>
        <div class="senha">
          <label for="inputPassword3" class="col-sm-2 col-form-label"><h4></h4></label>
          <div class="senha1">
...
<a href="projeto_acex_login.php">
 ...
 <a href="formulario.php"> <center>  <img src="Projeto/imagem/formulario.png" alt="formulario" width="35px" height="35px" ></center><br></a>
  ...
  <!------------------------------------------ TITULO CURSO---------------------------------------------------->
     ...
     <div   id="conteudoTexto"><center> <input type="submit" name="submit" value="Enviar"></center> 
      
        <a href="formulario.php"><br><center> <button type="button" class="btn ">Cadastrar</button></center> </a>
     </div> 
